...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for drills, practices, and matches",
    ...
    "Drama Club": {
        "description": "Explore acting, stagecraft, and put on school productions",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["ashley@mergington.edu", "jack@mergington.edu"]
    },
    "Art Club": {
    ...
    "Science Club": {
        "description": "Perform experiments and explore scientific topics",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
